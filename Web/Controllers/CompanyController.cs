...
namespace DataTableEditable.Controllers
{
	public class CompanyController : Controller
	{
		...
		/// </summary>
		/// <returns></returns>
		public ActionResult GetOneCompany()
		{
			return Json(new Company() { ID = 1, Address = "1", Name = "Test", Handel = "Handel", Town = "Town" }, JsonRequestBehavior.AllowGet);
		}
		...
		//    return null;
		//}
		//public ActionResult GetAllPoup()
		//{
		//    //SystemConfig config = new SystemConfig();
		//    //return Json(config.GetAll(), JsonRequestBehavior.AllowGet);
		//}
