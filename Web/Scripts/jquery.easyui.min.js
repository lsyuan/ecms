...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必填内容.",invalidMessage:null,rules:{email:{validator:function(_39c){
...
},message:"请输入正确的电子邮件地址."},url:{validator:function(_39d){
...
},message:"请输入一个合法的URL地址."},length:{validator:function(_39e,_39f){
var len=$.trim(_39e).length;
return len>=_39f[0]&&len<=_39f[1];
},message:"输入内容长度在{0}-{1}之间."},remote:{validator:function(_3a0,_3a1){
var data={};
data[_3a1[1]]=_3a0;
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"数据加载中 ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_5e5,_5e6){
